<table class="afl_table">
    ...
    <tr>
        ...
        <td><a class="afl_button" href="<?php echo get_post_meta(get_the_ID(),'tracking_url',1)?>"><?php echo $affiliator->affiliator_get_option('buy_now_button_text','Τσέκαρε την τιμή του')?></a></td>
    </tr>
    <?php endwhile?>
</table>
<?php
