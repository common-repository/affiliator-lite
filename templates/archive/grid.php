    ...
    <?php while ( have_posts() ) : the_post(); ?>
        <li>
            ...
            <div class="afl_buttons_wrapper">
                <a class="afl_button" href="<?php echo get_post_meta(get_the_ID(),'tracking_url',1)?>"><?php echo $affiliator->affiliator_get_option('buy_now_button_text','Τσέκαρε την τιμή του')?></a>
            </div>
